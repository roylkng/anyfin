...
import { AmtComponent } from '../../AmtComponent';
...
class Countries extends React.Component {
    ...
    constructor(props) {
        ...
        this.handleInputOk = this.handleInputOk.bind(this);
        this.state = initialState
    }

    componentDidMount() {
        //  this.props.getCountryByName("India")
    }
    ...
    handleInputOk(val){
        this.setState({ inputAmt: parseInt(val,10) });
        if (val) {
            value = val;
            showList = false;
            this.props.getCountryByName(this.state.searched);
        } else {
            showList = true;
            value = '';
            // this.props.getCountries();
    ...
    render() {
        ...
        const inputAmt = this.state.inputAmt;
        ...
        return (
            <ContainerDiv className="container">
                ...
                <AmtComponent  handleSearch={this.handleInputOk} />
